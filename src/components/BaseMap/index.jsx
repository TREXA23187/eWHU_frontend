...
const serviceUrl = `http://${baseUrl}:8090/iserver/services/transportationAnalyst-whu_map/rest/networkanalyst/whu_map_Network@whu_map`
const bufferUrl = `http://${baseUrl}:8090/iserver/services/spatialAnalysis-whu_map/restjsr/spatialanalyst`
...
export default function BaseMap(props) {
    ...
    useEffect(() => {
        ...
        console.log(mapRef.current.setCl)
        mapRef.current.addEventListener('load', () => console.log(12312321))
    ...
    const handleBuffer = () => {
        ...
        bufferAnalystService.bufferAnalysis(geoBufferAnalystParams, serviceResult => {
            ...
            queryService.queryByGeometry(queryByGeometryParameters, serviceResult => {
                ...
                const resultLayer1 = L.geoJSON(result.recordsets[0].features).addTo(map)
            })
        })
    }
